...
(function ($) {
    ...
    var removeTags = function ($el) {
        $el.find('br[data-owner="h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1"]').replaceWith(document.createTextNode(" "));
        var $span = $el.find('span[data-owner="h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1"]');
        if ($span.length > 0) {
            var txt = "";
            $span.each(function () {
                txt += $(this).text();
    ...
    var justify = function ($el, txt, conWidth) {
        ...
        tmp.css('word-spacing', wordSpacing + 'px')
            .attr('data-owner', 'h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1');
    ...
    $.fn.balanceText = function () {
        ...
        return this.each(function () {
            ...
            removeTags($this);                        // strip h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1 tags
            ...
            if (containerWidth > 0 &&                  // prevent divide by zero
                ...
                while (remLines > 1) {
                    ...
                    if (shouldJustify) {
                        ...
                        newText += lineText;
                        newText += '<br data-owner="h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1" />';
                    }
    ...
    // Call the balanceText plugin on the elements with "h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1" class. When a browser
    ...
    function applyBalanceText() {
        $(".h1, h2, h3, h4, #next-chapter p, #sidebar li, #sidebar h1").balanceText();
    }
