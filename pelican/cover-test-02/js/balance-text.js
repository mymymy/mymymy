...
(function ($) {
    ...
    var removeTags = function ($el) {
        $el.find('br[data-owner="h1, h2, h3, h4"]').replaceWith(document.createTextNode(" "));
        var $span = $el.find('span[data-owner="h1, h2, h3, h4"]');
        if ($span.length > 0) {
            var txt = "";
            $span.each(function () {
                txt += $(this).text();
    ...
    $.fn.balanceText = function () {
        ...
        return this.each(function () {
            ...
            removeTags($this);                        // strip h1, h2, h3, h4 tags
            ...
            if (containerWidth > 0 &&                  // prevent divide by zero
                ...
                while (remLines > 1) {
                    ...
                    if (shouldJustify) {
                        ...
                        newText += lineText;
                        newText += '<br data-owner="h1, h2, h3, h4" />';
                    }
    ...
    // Call the balanceText plugin on the elements with "h1, h2, h3, h4" class. When a browser
