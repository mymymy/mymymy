...
(function ($) {
    ...
    var removeTags = function ($el) {
        $el.find('br[data-owner="h1, h2, h3, h4, #next-chapter p"]').replaceWith(document.createTextNode(" "));
        var $span = $el.find('span[data-owner="h1, h2, h3, h4, #next-chapter p"]');
        if ($span.length > 0) {
            var txt = "";
            $span.each(function () {
                txt += $(this).text();
    ...
    var justify = function ($el, txt, conWidth) {
        ...
        tmp.css('word-spacing', wordSpacing + 'px')
            .attr('data-owner', 'h1, h2, h3, h4, #next-chapter p');
    ...
    $.fn.balanceText = function () {
        ...
        return this.each(function () {
            ...
            removeTags($this);                        // strip h1, h2, h3, h4, #next-chapter p tags
            ...
            if (containerWidth > 0 &&                  // prevent divide by zero
                ...
                while (remLines > 1) {
                    ...
                    if (shouldJustify) {
                        ...
                        newText += lineText;
                        newText += '<br data-owner="h1, h2, h3, h4, #next-chapter p" />';
                    }
    ...
    // Call the balanceText plugin on the elements with "h1, h2, h3, h4, #next-chapter p" class. When a browser
    ...
    function applyBalanceText() {
        $(".h1, h2, h3, h4, #next-chapter p").balanceText();
    }
